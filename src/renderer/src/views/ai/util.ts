...
import { QueryBuildParams } from '@renderer/api/data';

const getCellClass: CellClassFunc<StrategyRecordItem> = ({ data }) => {
...
//   columns: ColDef<StrategyRecordItem>[];
//   permissionNames?: string[];
//   suffix?: boolean;
// }

export const prefixColumns: ColDef<StrategyRecordItem>[] = [
  {
    headerName: '股票名称',
    field: 'stock.name',
    width: 90,
...
export const suffixColumns: ColDef<StrategyRecordItem>[] = [
  {
    headerName: '总市值',
...
export const defaultParams: () => QueryBuildParams = () => ({
  key_words: undefined,
  time_type: 2,
  color: 'red',
  type: 'build',
